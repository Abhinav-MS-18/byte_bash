          ...
          <form onSubmit={handleRequestSubmit} className="flex flex-wrap">
            <div className="w-1/2 pr-2">
              ...
              <div className="mb-4 mx-4">
                <Label
                  htmlFor="duration"
                  value="Duration (in Months, optional)"
                />
                <TextInput
                  id="duration"
                  type="number"
            ...
            lenders.map((lender, index) => (
              <Card key={index} className="max-h-28 flex py-2">
                <div className="flex w-full justify-between px-4 py-2">
                  <div>
                    <p>
                      <strong>Name:</strong> {lender.user_name}
                    </p>
                    <p>
                      <strong>Amount:</strong> ₹{lender.amount}
                    </p>
                    <p>
                      <strong>Interest Range:</strong> {lender.interest_range}
                    </p>
                    <p>
                      <strong>Duration:</strong> {lender.duration} months
                    </p>
                  </div>
